...
},{}],"crud.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.update = exports.deleteOpp = exports.create = exports.checkboxChecked = void 0;
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* disable-eslint */
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(todo) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          (0, _alerts.showAlert)('success', 'Added Todo!');
...
var update = exports.update = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(todo, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          (0, _alerts.showAlert)('success', 'Updated Todo!');
          window.setTimeout(function () {
            location.reload();
          }, 500);
          _context2.next = 11;
...
var deleteOpp = exports.deleteOpp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          (0, _alerts.showAlert)('success', 'Deleted Todo!');
          window.setTimeout(function () {
            location.reload();
          }, 500);
          _context3.next = 11;
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', _context3.t0.message);
        case 11:
        case "end":
  ...
  return function deleteOpp(_x4) {
    return _ref3.apply(this, arguments);
  };
}();
var checkboxChecked = exports.checkboxChecked = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(completed, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', _context4.t0.message);
        case 10:
        case "end":
  ...
  return function checkboxChecked(_x5, _x6) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)('error', 'Cannot Logout at this moment!');
        case 10:
        case "end":
          return _context2.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "Cant Signup at this moment, try later");
        case 11:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "Couldn't send the email!");
        case 10:
        case "end":
          return _context.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', "Cannot Change your password!");
        case 10:
        case "end":
          return _context.stop();
      }
...
var form = document.querySelector('.form__todo');
var input = document.querySelector('.todo__input');
var addTodo = document.querySelector('.add__todo');
var updateTodo = document.querySelector('.update__todo');
...
var resetPasswordPasswordForm = document.querySelector('.form--resetPassword');
var logoutLink = document.querySelector('.logout__link');
var themeToggleButtons = document.querySelectorAll('.theme-icons');
var currentTheme = localStorage.getItem('theme');
if (form && updateBtn.length > 0) {
  updateBtn.forEach(function (updateBtn, index) {
    updateBtn.addEventListener('click', function (e) {
      e.preventDefault();
      var todoText = todos[index].querySelector('.todo__list').textContent;
...
if (form && updateBtn.length > 0) {
  updateBtn.forEach(function (el, index) {
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (!updateTodo.classList.contains('hidden')) {
      var text = input.value;
      (0, _crud.update)(text, currentTodoId);
    }
  });
}
if (form && deleteBtn.length > 0) {
  deleteBtn.forEach(function (el) {
    el.addEventListener('click', function (e) {
      e.preventDefault();
      currentTodoId = el.getAttribute('data');
      (0, _crud.deleteOpp)(currentTodoId);
    });
  });
}
if (checkbox) {
  checkbox.forEach(function (el) {
    el.addEventListener('change', function (e) {
      e.preventDefault();
      var id = el.closest('.list').querySelector('.update').getAttribute('data');
      var completed = el.checked;
      if (el.checked) {
        (0, _alerts.showAlert)('success', 'Todo Completed!');
      }
      (0, _crud.checkboxChecked)(completed, id);
    });
  });
}
if (loginForm) {
...
if (resetPasswordPasswordForm) {
  resetPasswordPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('password-confirm').value;
...
},{"./crud":"crud.js","./login":"login.js","./signup":"signup.js","./forgotPassword":"forgotPassword.js","./resetPassword":"resetPassword.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
